...
(
    ...
    localparam PAD5 = log2ceil(64'h410b0 - 64'h410a0); 
    localparam PAD6 = log2ceil(64'h410c0 - 64'h410b0); 
    ...
    // ( 0x410b0 .. 0x410c0 )
    if ( {address[RG:PAD6],{PAD6{1'b0}}} == 19'h410b0   ) begin
            src_channel = 11'b00001000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 5;
    end

    // ( 0x410c0 .. 0x410d0 )
    if ( {address[RG:PAD7],{PAD7{1'b0}}} == 19'h410c0  && read_transaction  ) begin
