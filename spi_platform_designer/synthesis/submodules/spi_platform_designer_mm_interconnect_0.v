...
module spi_platform_designer_mm_interconnect_0 (
	...
	wire   [9:0] cmd_mux_002_src_channel;                                                    // cmd_mux_002:src_channel -> NIOS_debug_mem_slave_agent:cp_channel
	...
	wire   [9:0] cmd_mux_004_src_channel;                                                    // cmd_mux_004:src_channel -> ESC_SPI_CS_s1_agent:cp_channel
	...
	wire   [9:0] cmd_mux_005_src_channel;                                                    // cmd_mux_005:src_channel -> ESC_EEPDONE_INPUT_s1_agent:cp_channel
	...
	wire   [9:0] cmd_mux_007_src_channel;                                                    // cmd_mux_007:src_channel -> ESC_SPI_SINT_s1_agent:cp_channel
	...
	wire  [96:0] cmd_mux_008_src_data;                                                       // cmd_mux_008:src_data -> ESC_SPI_spi_control_port_agent:cp_data
	wire         cmd_mux_008_src_ready;                                                      // ESC_SPI_spi_control_port_agent:cp_ready -> cmd_mux_008:src_ready
	wire   [9:0] cmd_mux_008_src_channel;                                                    // cmd_mux_008:src_channel -> ESC_SPI_spi_control_port_agent:cp_channel
	...
	wire  [96:0] cmd_mux_009_src_data;                                                       // cmd_mux_009:src_data -> timer_0_s1_agent:cp_data
	...
	wire  [96:0] esc_spi_spi_control_port_agent_rp_data;                                     // ESC_SPI_spi_control_port_agent:rp_data -> router_010:sink_data
	...
	wire  [96:0] timer_0_s1_agent_rp_data;                                                   // timer_0_s1_agent:rp_data -> router_011:sink_data
	...
	wire  [96:0] router_src_data;                                                            // router:src_data -> NIOS_data_master_limiter:cmd_sink_data
	wire         router_src_ready;                                                           // NIOS_data_master_limiter:cmd_sink_ready -> router:src_ready
	wire   [9:0] router_src_channel;                                                         // router:src_channel -> NIOS_data_master_limiter:cmd_sink_channel
	...
	wire  [96:0] nios_data_master_limiter_cmd_src_data;                                      // NIOS_data_master_limiter:cmd_src_data -> cmd_demux:sink_data
	wire         nios_data_master_limiter_cmd_src_ready;                                     // cmd_demux:sink_ready -> NIOS_data_master_limiter:cmd_src_ready
	wire   [9:0] nios_data_master_limiter_cmd_src_channel;                                   // NIOS_data_master_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire  [96:0] rsp_mux_src_data;                                                           // rsp_mux:src_data -> NIOS_data_master_limiter:rsp_sink_data
	wire         rsp_mux_src_ready;                                                          // NIOS_data_master_limiter:rsp_sink_ready -> rsp_mux:src_ready
	wire   [9:0] rsp_mux_src_channel;                                                        // rsp_mux:src_channel -> NIOS_data_master_limiter:rsp_sink_channel
	...
	wire  [96:0] nios_data_master_limiter_rsp_src_data;                                      // NIOS_data_master_limiter:rsp_src_data -> NIOS_data_master_agent:rp_data
	wire         nios_data_master_limiter_rsp_src_ready;                                     // NIOS_data_master_agent:rp_ready -> NIOS_data_master_limiter:rsp_src_ready
	wire   [9:0] nios_data_master_limiter_rsp_src_channel;                                   // NIOS_data_master_limiter:rsp_src_channel -> NIOS_data_master_agent:rp_channel
	...
	wire  [96:0] router_001_src_data;                                                        // router_001:src_data -> NIOS_instruction_master_limiter:cmd_sink_data
	wire         router_001_src_ready;                                                       // NIOS_instruction_master_limiter:cmd_sink_ready -> router_001:src_ready
	wire   [9:0] router_001_src_channel;                                                     // router_001:src_channel -> NIOS_instruction_master_limiter:cmd_sink_channel
	...
	wire  [96:0] nios_instruction_master_limiter_cmd_src_data;                               // NIOS_instruction_master_limiter:cmd_src_data -> cmd_demux_001:sink_data
	...
	wire   [9:0] nios_instruction_master_limiter_cmd_src_channel;                            // NIOS_instruction_master_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	...
	wire  [96:0] rsp_mux_001_src_data;                                                       // rsp_mux_001:src_data -> NIOS_instruction_master_limiter:rsp_sink_data
	wire         rsp_mux_001_src_ready;                                                      // NIOS_instruction_master_limiter:rsp_sink_ready -> rsp_mux_001:src_ready
	wire   [9:0] rsp_mux_001_src_channel;                                                    // rsp_mux_001:src_channel -> NIOS_instruction_master_limiter:rsp_sink_channel
	...
	wire  [96:0] nios_instruction_master_limiter_rsp_src_data;                               // NIOS_instruction_master_limiter:rsp_src_data -> NIOS_instruction_master_agent:rp_data
	...
	wire   [9:0] nios_instruction_master_limiter_rsp_src_channel;                            // NIOS_instruction_master_limiter:rsp_src_channel -> NIOS_instruction_master_agent:rp_channel
	...
	wire  [96:0] cmd_demux_001_src2_data;                                                    // cmd_demux_001:src2_data -> cmd_mux_009:sink0_data
	...
	wire  [96:0] rsp_demux_009_src0_data;                                                    // rsp_demux_009:src0_data -> rsp_mux_001:sink2_data
	...
	wire   [9:0] nios_data_master_limiter_cmd_valid_data;                                    // NIOS_data_master_limiter:cmd_src_valid -> cmd_demux:sink_valid
	wire   [9:0] nios_instruction_master_limiter_cmd_valid_data;                             // NIOS_instruction_master_limiter:cmd_src_valid -> cmd_demux_001:sink_valid
	...
	spi_platform_designer_mm_interconnect_0_router_011 router_011 (
	...
	spi_platform_designer_mm_interconnect_0_rsp_demux_002 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                          //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	spi_platform_designer_mm_interconnect_0_rsp_demux_002 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                          //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
