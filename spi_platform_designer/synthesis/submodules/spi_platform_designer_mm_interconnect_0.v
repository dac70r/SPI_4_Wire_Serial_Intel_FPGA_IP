...
module spi_platform_designer_mm_interconnect_0 (
	...
	wire  [93:0] cmd_mux_src_data;                                                           // cmd_mux:src_data -> NIOS_debug_mem_slave_agent:cp_data
	...
	wire   [5:0] cmd_mux_001_src_channel;                                                    // cmd_mux_001:src_channel -> RAM_s1_agent:cp_channel
	...
	wire  [94:0] esc_spi_cs_s1_agent_rf_source_data;                                         // ESC_SPI_CS_s1_agent:rf_source_data -> ESC_SPI_CS_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] esc_spi_cs_s1_agent_rsp_fifo_out_data;                                      // ESC_SPI_CS_s1_agent_rsp_fifo:out_data -> ESC_SPI_CS_s1_agent:rf_sink_data
	...
	wire         cmd_mux_002_src_valid;                                                      // cmd_mux_002:src_valid -> ESC_SPI_CS_s1_agent:cp_valid
	wire  [93:0] cmd_mux_002_src_data;                                                       // cmd_mux_002:src_data -> ESC_SPI_CS_s1_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                      // ESC_SPI_CS_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [5:0] cmd_mux_002_src_channel;                                                    // cmd_mux_002:src_channel -> ESC_SPI_CS_s1_agent:cp_channel
	wire         cmd_mux_002_src_startofpacket;                                              // cmd_mux_002:src_startofpacket -> ESC_SPI_CS_s1_agent:cp_startofpacket
	wire         cmd_mux_002_src_endofpacket;                                                // cmd_mux_002:src_endofpacket -> ESC_SPI_CS_s1_agent:cp_endofpacket
	...
	wire  [17:0] esc_eepdone_input_s1_agent_m0_address;                                      // ESC_EEPDONE_INPUT_s1_agent:m0_address -> ESC_EEPDONE_INPUT_s1_translator:uav_address
	...
	wire  [94:0] esc_eepdone_input_s1_agent_rf_source_data;                                  // ESC_EEPDONE_INPUT_s1_agent:rf_source_data -> ESC_EEPDONE_INPUT_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] esc_eepdone_input_s1_agent_rsp_fifo_out_data;                               // ESC_EEPDONE_INPUT_s1_agent_rsp_fifo:out_data -> ESC_EEPDONE_INPUT_s1_agent:rf_sink_data
	...
	wire         cmd_mux_003_src_valid;                                                      // cmd_mux_003:src_valid -> ESC_EEPDONE_INPUT_s1_agent:cp_valid
	wire  [93:0] cmd_mux_003_src_data;                                                       // cmd_mux_003:src_data -> ESC_EEPDONE_INPUT_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                      // ESC_EEPDONE_INPUT_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [5:0] cmd_mux_003_src_channel;                                                    // cmd_mux_003:src_channel -> ESC_EEPDONE_INPUT_s1_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                              // cmd_mux_003:src_startofpacket -> ESC_EEPDONE_INPUT_s1_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                                // cmd_mux_003:src_endofpacket -> ESC_EEPDONE_INPUT_s1_agent:cp_endofpacket
	...
	wire  [93:0] cmd_mux_005_src_data;                                                       // cmd_mux_005:src_data -> ESC_SPI_spi_control_port_agent:cp_data
	...
	wire  [93:0] nios_debug_mem_slave_agent_rp_data;                                         // NIOS_debug_mem_slave_agent:rp_data -> router_002:sink_data
	...
	wire         esc_spi_cs_s1_agent_rp_valid;                                               // ESC_SPI_CS_s1_agent:rp_valid -> router_004:sink_valid
	wire  [93:0] esc_spi_cs_s1_agent_rp_data;                                                // ESC_SPI_CS_s1_agent:rp_data -> router_004:sink_data
	wire         esc_spi_cs_s1_agent_rp_ready;                                               // router_004:sink_ready -> ESC_SPI_CS_s1_agent:rp_ready
	wire         esc_spi_cs_s1_agent_rp_startofpacket;                                       // ESC_SPI_CS_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire         esc_spi_cs_s1_agent_rp_endofpacket;                                         // ESC_SPI_CS_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire         esc_eepdone_input_s1_agent_rp_valid;                                        // ESC_EEPDONE_INPUT_s1_agent:rp_valid -> router_005:sink_valid
	wire  [93:0] esc_eepdone_input_s1_agent_rp_data;                                         // ESC_EEPDONE_INPUT_s1_agent:rp_data -> router_005:sink_data
	wire         esc_eepdone_input_s1_agent_rp_ready;                                        // router_005:sink_ready -> ESC_EEPDONE_INPUT_s1_agent:rp_ready
	wire         esc_eepdone_input_s1_agent_rp_startofpacket;                                // ESC_EEPDONE_INPUT_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         esc_eepdone_input_s1_agent_rp_endofpacket;                                  // ESC_EEPDONE_INPUT_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire  [93:0] esc_spi_spi_control_port_agent_rp_data;                                     // ESC_SPI_spi_control_port_agent:rp_data -> router_007:sink_data
	...
	wire         esc_spi_cs_s1_agent_rdata_fifo_src_valid;                                   // ESC_SPI_CS_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire  [33:0] esc_spi_cs_s1_agent_rdata_fifo_src_data;                                    // ESC_SPI_CS_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire         esc_spi_cs_s1_agent_rdata_fifo_src_ready;                                   // avalon_st_adapter_002:in_0_ready -> ESC_SPI_CS_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_002_out_0_valid;                                          // avalon_st_adapter_002:out_0_valid -> ESC_SPI_CS_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_002_out_0_data;                                           // avalon_st_adapter_002:out_0_data -> ESC_SPI_CS_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_002_out_0_ready;                                          // ESC_SPI_CS_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire   [0:0] avalon_st_adapter_002_out_0_error;                                          // avalon_st_adapter_002:out_0_error -> ESC_SPI_CS_s1_agent:rdata_fifo_sink_error
	wire         esc_eepdone_input_s1_agent_rdata_fifo_src_valid;                            // ESC_EEPDONE_INPUT_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] esc_eepdone_input_s1_agent_rdata_fifo_src_data;                             // ESC_EEPDONE_INPUT_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         esc_eepdone_input_s1_agent_rdata_fifo_src_ready;                            // avalon_st_adapter_003:in_0_ready -> ESC_EEPDONE_INPUT_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_003_out_0_valid;                                          // avalon_st_adapter_003:out_0_valid -> ESC_EEPDONE_INPUT_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                           // avalon_st_adapter_003:out_0_data -> ESC_EEPDONE_INPUT_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                          // ESC_EEPDONE_INPUT_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                          // avalon_st_adapter_003:out_0_error -> ESC_EEPDONE_INPUT_s1_agent:rdata_fifo_sink_error
	...
	spi_platform_designer_mm_interconnect_0_router_004 router_006 (
	...
	spi_platform_designer_mm_interconnect_0_router_004 router_007 (
	...
	spi_platform_designer_mm_interconnect_0_cmd_mux_002 cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                          //       clk.clk
		.reset               (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	spi_platform_designer_mm_interconnect_0_cmd_mux_002 cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                          //       clk.clk
		.reset               (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	spi_platform_designer_mm_interconnect_0_cmd_demux_001 rsp_demux (
		.clk                (clk_0_clk_clk),                          //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	spi_platform_designer_mm_interconnect_0_rsp_demux_002 rsp_demux_004 (
		.clk                (clk_0_clk_clk),                          //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	spi_platform_designer_mm_interconnect_0_rsp_demux_002 rsp_demux_005 (
		.clk                (clk_0_clk_clk),                          //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
