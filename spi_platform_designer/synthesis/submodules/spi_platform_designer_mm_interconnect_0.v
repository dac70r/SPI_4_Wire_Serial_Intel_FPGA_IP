...
module spi_platform_designer_mm_interconnect_0 (
	...
	wire   [7:0] cmd_mux_002_src_channel;                                                    // cmd_mux_002:src_channel -> NIOS_debug_mem_slave_agent:cp_channel
	...
	wire  [94:0] cmd_mux_003_src_data;                                                       // cmd_mux_003:src_data -> RAM_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                      // RAM_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [7:0] cmd_mux_003_src_channel;                                                    // cmd_mux_003:src_channel -> RAM_s1_agent:cp_channel
	...
	wire  [95:0] esc_spi_cs_s1_agent_rf_source_data;                                         // ESC_SPI_CS_s1_agent:rf_source_data -> ESC_SPI_CS_s1_agent_rsp_fifo:in_data
	...
	wire  [95:0] esc_spi_cs_s1_agent_rsp_fifo_out_data;                                      // ESC_SPI_CS_s1_agent_rsp_fifo:out_data -> ESC_SPI_CS_s1_agent:rf_sink_data
	...
	wire  [94:0] cmd_mux_004_src_data;                                                       // cmd_mux_004:src_data -> ESC_SPI_CS_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                      // ESC_SPI_CS_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [7:0] cmd_mux_004_src_channel;                                                    // cmd_mux_004:src_channel -> ESC_SPI_CS_s1_agent:cp_channel
	...
	wire  [95:0] esc_eepdone_input_s1_agent_rf_source_data;                                  // ESC_EEPDONE_INPUT_s1_agent:rf_source_data -> ESC_EEPDONE_INPUT_s1_agent_rsp_fifo:in_data
	...
	wire  [95:0] esc_eepdone_input_s1_agent_rsp_fifo_out_data;                               // ESC_EEPDONE_INPUT_s1_agent_rsp_fifo:out_data -> ESC_EEPDONE_INPUT_s1_agent:rf_sink_data
	...
	wire  [94:0] cmd_mux_005_src_data;                                                       // cmd_mux_005:src_data -> ESC_EEPDONE_INPUT_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                      // ESC_EEPDONE_INPUT_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [7:0] cmd_mux_005_src_channel;                                                    // cmd_mux_005:src_channel -> ESC_EEPDONE_INPUT_s1_agent:cp_channel
	...
	wire  [94:0] cmd_mux_007_src_data;                                                       // cmd_mux_007:src_data -> ESC_SPI_spi_control_port_agent:cp_data
	...
	wire  [94:0] ram_s1_agent_rp_data;                                                       // RAM_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [94:0] esc_spi_cs_s1_agent_rp_data;                                                // ESC_SPI_CS_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [94:0] esc_eepdone_input_s1_agent_rp_data;                                         // ESC_EEPDONE_INPUT_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [94:0] esc_spi_spi_control_port_agent_rp_data;                                     // ESC_SPI_spi_control_port_agent:rp_data -> router_009:sink_data
