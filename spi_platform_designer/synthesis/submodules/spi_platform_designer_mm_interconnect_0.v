...
module spi_platform_designer_mm_interconnect_0 (
		...
		output wire [1:0]  SPI_SS_MANUAL_s1_address,               //                 SPI_SS_MANUAL_s1.address
		output wire        SPI_SS_MANUAL_s1_write,                 //                                 .write
		input  wire [31:0] SPI_SS_MANUAL_s1_readdata,              //                                 .readdata
		output wire [31:0] SPI_SS_MANUAL_s1_writedata,             //                                 .writedata
		output wire        SPI_SS_MANUAL_s1_chipselect             //                                 .chipselect
	);
	...
	wire  [31:0] spi_ss_manual_s1_agent_m0_readdata;                                         // SPI_SS_MANUAL_s1_translator:uav_readdata -> SPI_SS_MANUAL_s1_agent:m0_readdata
	wire         spi_ss_manual_s1_agent_m0_waitrequest;                                      // SPI_SS_MANUAL_s1_translator:uav_waitrequest -> SPI_SS_MANUAL_s1_agent:m0_waitrequest
	wire         spi_ss_manual_s1_agent_m0_debugaccess;                                      // SPI_SS_MANUAL_s1_agent:m0_debugaccess -> SPI_SS_MANUAL_s1_translator:uav_debugaccess
	wire  [17:0] spi_ss_manual_s1_agent_m0_address;                                          // SPI_SS_MANUAL_s1_agent:m0_address -> SPI_SS_MANUAL_s1_translator:uav_address
	wire   [3:0] spi_ss_manual_s1_agent_m0_byteenable;                                       // SPI_SS_MANUAL_s1_agent:m0_byteenable -> SPI_SS_MANUAL_s1_translator:uav_byteenable
	wire         spi_ss_manual_s1_agent_m0_read;                                             // SPI_SS_MANUAL_s1_agent:m0_read -> SPI_SS_MANUAL_s1_translator:uav_read
	wire         spi_ss_manual_s1_agent_m0_readdatavalid;                                    // SPI_SS_MANUAL_s1_translator:uav_readdatavalid -> SPI_SS_MANUAL_s1_agent:m0_readdatavalid
	wire         spi_ss_manual_s1_agent_m0_lock;                                             // SPI_SS_MANUAL_s1_agent:m0_lock -> SPI_SS_MANUAL_s1_translator:uav_lock
	wire  [31:0] spi_ss_manual_s1_agent_m0_writedata;                                        // SPI_SS_MANUAL_s1_agent:m0_writedata -> SPI_SS_MANUAL_s1_translator:uav_writedata
	wire         spi_ss_manual_s1_agent_m0_write;                                            // SPI_SS_MANUAL_s1_agent:m0_write -> SPI_SS_MANUAL_s1_translator:uav_write
	wire   [2:0] spi_ss_manual_s1_agent_m0_burstcount;                                       // SPI_SS_MANUAL_s1_agent:m0_burstcount -> SPI_SS_MANUAL_s1_translator:uav_burstcount
	wire         spi_ss_manual_s1_agent_rf_source_valid;                                     // SPI_SS_MANUAL_s1_agent:rf_source_valid -> SPI_SS_MANUAL_s1_agent_rsp_fifo:in_valid
	wire  [94:0] spi_ss_manual_s1_agent_rf_source_data;                                      // SPI_SS_MANUAL_s1_agent:rf_source_data -> SPI_SS_MANUAL_s1_agent_rsp_fifo:in_data
	wire         spi_ss_manual_s1_agent_rf_source_ready;                                     // SPI_SS_MANUAL_s1_agent_rsp_fifo:in_ready -> SPI_SS_MANUAL_s1_agent:rf_source_ready
	wire         spi_ss_manual_s1_agent_rf_source_startofpacket;                             // SPI_SS_MANUAL_s1_agent:rf_source_startofpacket -> SPI_SS_MANUAL_s1_agent_rsp_fifo:in_startofpacket
	wire         spi_ss_manual_s1_agent_rf_source_endofpacket;                               // SPI_SS_MANUAL_s1_agent:rf_source_endofpacket -> SPI_SS_MANUAL_s1_agent_rsp_fifo:in_endofpacket
	wire         spi_ss_manual_s1_agent_rsp_fifo_out_valid;                                  // SPI_SS_MANUAL_s1_agent_rsp_fifo:out_valid -> SPI_SS_MANUAL_s1_agent:rf_sink_valid
	wire  [94:0] spi_ss_manual_s1_agent_rsp_fifo_out_data;                                   // SPI_SS_MANUAL_s1_agent_rsp_fifo:out_data -> SPI_SS_MANUAL_s1_agent:rf_sink_data
	wire         spi_ss_manual_s1_agent_rsp_fifo_out_ready;                                  // SPI_SS_MANUAL_s1_agent:rf_sink_ready -> SPI_SS_MANUAL_s1_agent_rsp_fifo:out_ready
	wire         spi_ss_manual_s1_agent_rsp_fifo_out_startofpacket;                          // SPI_SS_MANUAL_s1_agent_rsp_fifo:out_startofpacket -> SPI_SS_MANUAL_s1_agent:rf_sink_startofpacket
	wire         spi_ss_manual_s1_agent_rsp_fifo_out_endofpacket;                            // SPI_SS_MANUAL_s1_agent_rsp_fifo:out_endofpacket -> SPI_SS_MANUAL_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_003_src_valid;                                                      // cmd_mux_003:src_valid -> SPI_SS_MANUAL_s1_agent:cp_valid
	wire  [93:0] cmd_mux_003_src_data;                                                       // cmd_mux_003:src_data -> SPI_SS_MANUAL_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                      // SPI_SS_MANUAL_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [4:0] cmd_mux_003_src_channel;                                                    // cmd_mux_003:src_channel -> SPI_SS_MANUAL_s1_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                              // cmd_mux_003:src_startofpacket -> SPI_SS_MANUAL_s1_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                                // cmd_mux_003:src_endofpacket -> SPI_SS_MANUAL_s1_agent:cp_endofpacket
	...
	wire  [93:0] cmd_mux_004_src_data;                                                       // cmd_mux_004:src_data -> SPI_spi_control_port_agent:cp_data
	...
	wire         spi_ss_manual_s1_agent_rp_valid;                                            // SPI_SS_MANUAL_s1_agent:rp_valid -> router_005:sink_valid
	wire  [93:0] spi_ss_manual_s1_agent_rp_data;                                             // SPI_SS_MANUAL_s1_agent:rp_data -> router_005:sink_data
	wire         spi_ss_manual_s1_agent_rp_ready;                                            // router_005:sink_ready -> SPI_SS_MANUAL_s1_agent:rp_ready
	wire         spi_ss_manual_s1_agent_rp_startofpacket;                                    // SPI_SS_MANUAL_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         spi_ss_manual_s1_agent_rp_endofpacket;                                      // SPI_SS_MANUAL_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire  [93:0] spi_spi_control_port_agent_rp_data;                                         // SPI_spi_control_port_agent:rp_data -> router_006:sink_data
	...
	wire         spi_ss_manual_s1_agent_rdata_fifo_src_valid;                                // SPI_SS_MANUAL_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] spi_ss_manual_s1_agent_rdata_fifo_src_data;                                 // SPI_SS_MANUAL_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         spi_ss_manual_s1_agent_rdata_fifo_src_ready;                                // avalon_st_adapter_003:in_0_ready -> SPI_SS_MANUAL_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_003_out_0_valid;                                          // avalon_st_adapter_003:out_0_valid -> SPI_SS_MANUAL_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                           // avalon_st_adapter_003:out_0_data -> SPI_SS_MANUAL_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                          // SPI_SS_MANUAL_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                          // avalon_st_adapter_003:out_0_error -> SPI_SS_MANUAL_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) spi_ss_manual_s1_translator (
		.clk                    (clk_0_clk_clk),                           //                      clk.clk
		.reset                  (NIOS_reset_reset_bridge_in_reset_reset),  //                    reset.reset
		.uav_address            (spi_ss_manual_s1_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (spi_ss_manual_s1_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (spi_ss_manual_s1_agent_m0_read),          //                         .read
		.uav_write              (spi_ss_manual_s1_agent_m0_write),         //                         .write
		.uav_waitrequest        (spi_ss_manual_s1_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (spi_ss_manual_s1_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (spi_ss_manual_s1_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (spi_ss_manual_s1_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (spi_ss_manual_s1_agent_m0_writedata),     //                         .writedata
		.uav_lock               (spi_ss_manual_s1_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (spi_ss_manual_s1_agent_m0_debugaccess),   //                         .debugaccess
		.av_address             (SPI_SS_MANUAL_s1_address),                //      avalon_anti_slave_0.address
		.av_write               (SPI_SS_MANUAL_s1_write),                  //                         .write
		.av_readdata            (SPI_SS_MANUAL_s1_readdata),               //                         .readdata
		.av_writedata           (SPI_SS_MANUAL_s1_writedata),              //                         .writedata
		.av_chipselect          (SPI_SS_MANUAL_s1_chipselect),             //                         .chipselect
		.av_read                (),                                        //              (terminated)
		.av_begintransfer       (),                                        //              (terminated)
		.av_beginbursttransfer  (),                                        //              (terminated)
		.av_burstcount          (),                                        //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) spi_ss_manual_s1_agent (
		.clk                     (clk_0_clk_clk),                                     //             clk.clk
		.reset                   (NIOS_reset_reset_bridge_in_reset_reset),            //       clk_reset.reset
		.m0_address              (spi_ss_manual_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (spi_ss_manual_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (spi_ss_manual_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (spi_ss_manual_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (spi_ss_manual_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (spi_ss_manual_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (spi_ss_manual_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (spi_ss_manual_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (spi_ss_manual_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (spi_ss_manual_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (spi_ss_manual_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (spi_ss_manual_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (spi_ss_manual_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (spi_ss_manual_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (spi_ss_manual_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (spi_ss_manual_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (spi_ss_manual_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (spi_ss_manual_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (spi_ss_manual_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (spi_ss_manual_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (spi_ss_manual_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (spi_ss_manual_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (spi_ss_manual_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (spi_ss_manual_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (spi_ss_manual_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (spi_ss_manual_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_003_out_0_ready),                 // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_003_out_0_valid),                 //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_003_out_0_data),                  //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_003_out_0_error),                 //                .error
		.rdata_fifo_src_ready    (spi_ss_manual_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (spi_ss_manual_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (spi_ss_manual_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                             //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                               //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) spi_ss_manual_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                     //       clk.clk
		.reset             (NIOS_reset_reset_bridge_in_reset_reset),            // clk_reset.reset
		.in_data           (spi_ss_manual_s1_agent_rf_source_data),             //        in.data
		.in_valid          (spi_ss_manual_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (spi_ss_manual_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (spi_ss_manual_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (spi_ss_manual_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (spi_ss_manual_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (spi_ss_manual_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (spi_ss_manual_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (spi_ss_manual_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (spi_ss_manual_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                             // (terminated)
		.csr_read          (1'b0),                                              // (terminated)
		.csr_write         (1'b0),                                              // (terminated)
		.csr_readdata      (),                                                  // (terminated)
	...
	spi_platform_designer_mm_interconnect_0_router_002 router_005 (
		.sink_ready         (spi_ss_manual_s1_agent_rp_ready),         //      sink.ready
		.sink_valid         (spi_ss_manual_s1_agent_rp_valid),         //          .valid
		.sink_data          (spi_ss_manual_s1_agent_rp_data),          //          .data
		.sink_startofpacket (spi_ss_manual_s1_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (spi_ss_manual_s1_agent_rp_endofpacket),   //          .endofpacket
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset),  // clk_reset.reset
	...
	spi_platform_designer_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                               // in_clk_0.clk
		.in_rst_0_reset (NIOS_reset_reset_bridge_in_reset_reset),      // in_rst_0.reset
		.in_0_data      (spi_ss_manual_s1_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (spi_ss_manual_s1_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (spi_ss_manual_s1_agent_rdata_fifo_src_ready), //         .ready
